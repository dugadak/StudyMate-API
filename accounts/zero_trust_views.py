...
from studymate_api.zero_trust_security import (
    zero_trust_engine, DeviceFingerprint, register_trusted_device, register_trusted_location
)
        ...
        for i, device in enumerate(user_devices):
            if device['fingerprint'].startswith(device_id):
                ...
                return Response({
                    ...
                    'device_name': removed_device['name']
                })
    ...
    def post(self, request):
        ...
        try:
            ...
            return Response({
                ...
                'message': 'MFA 챌린지 생성 중 오류가 발생했습니다.'
            }, status=status.HTTP_500_INTERNAL_SERVER_ERROR)
        ...
        try:
            ...
            if challenge_data['attempts'] >= 3:
                ...
                return Response({
                    ...
                    'message': '시도 횟수를 초과했습니다. 새로운 챌린지를 요청하세요.'
