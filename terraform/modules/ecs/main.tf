# ECS Module for TimeTree Event Creator
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        {
          name  = "TIMETREE_CLIENT_ID"
          value = var.timetree_client_id
        },
        {
          name  = "TIMETREE_CLIENT_SECRET"
          value = var.timetree_client_secret
        },
        {
...
resource "aws_iam_policy" "ecs_cloudwatch_policy" {
  name = "${var.project_name}-ecs-cloudwatch-policy-${var.environment}"
